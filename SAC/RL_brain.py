...
class SAC:
    def __init__(self, n_states, n_hiddens, n_actions,
                 ...
                 target_entropy, tau, gamma, device, writter):
        # 实例化策略网络
    ...
    # 软更新，每次训练后使用价值网络的参数更新目标网络的参数
    def soft_update(self, net, target_net):
        # 遍历预测网络和目标网络的参数，zip同维度拼接矩阵
    ...
    def update(self, transition_dict):
        ...
        self.writter.add_scalars("loss", {"critic_1_loss": critic_1_loss.item()}, self.learn_index)
        self.writter.add_scalars("loss", {"critic_2_loss": critic_2_loss.item()}, self.learn_index)
        self.writter.add_scalars("loss", {"actor_loss": actor_loss.item()}, self.learn_index)
        self.learn_index+=1